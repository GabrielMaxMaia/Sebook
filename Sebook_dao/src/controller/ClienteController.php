            ...
            foreach ($result as $linha) {
                $tabela .= "<tr>
                    <td>" . $linha['cpfCliente'] . "</td>
                        ...
                        <td>
                            <a href='http://localhost/PLAO3/Projetos/modelo_mvc_dao/index.php?area=adm&folder=cadastro&page=cadcliente&acao=2&id=" . $linha['idUsuario'] . "'>
                                <img src='public/img/editar.jpg'>
                            </a>
                        </td>
                        <td>
                            <a href='http://localhost/PLAO3/Projetos/modelo_mvc_dao/index.php?area=adm&folder=cadastro&page=cadcliente&acao=3&id=" . $linha['idUsuario'] . "'>
