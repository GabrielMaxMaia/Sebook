...
<head>
    ...
    <meta name=keywords content="Sebook Área de Administradores">
    <meta name=author content='Diva Cruz'>
    <meta name=sebookAdm content='área restrita aos Administradores do sistema'>

    <link rel="stylesheet" href="../cssAdm/Admin2.css">
    <title>Sebook Master</title>
</head>

<body class="">
    <header>
        <?php require_once 'menuMaster/menuMaster.php';?>
    </header>
    <h6>
        INSTRUÇÕES GERAIS: 1) A moderação dos tópicos publicados é feita após provocação (denúncia) e não por censura (prévia); 2) O controle é feito após provocação (denúncia) e avaliando se fere ou não as regras mínimas do site;3) Mensagem em tom de ameaça, ofensas ou provocação a um membro do grupo ou a coletividade será, desde que haja denúncia prévia, desativado, excluído ou podendo até - em razão da reincidência - o autor da postagem ser excluído como membro
        do grupo.
    </h6>
    <li>
        <a href="#">
