...
<section class="<?php echo $SeboController->getLista(); ?>">
	<table>
	 ...
	 <input class="button" type="button" onclick="window.location='http://localhost/Sebook/adm/cadastro/cadSebo/acao=1'"
	 value="Novo">
</section>
...
<section class="<?php echo $SeboController->getFormulario(); ?>">
	<form method="post" action="">
		...
		<input type="hidden" name="txtId" id="txtId" value="<?php echo $SeboController->getSeboDAO()->getIdSebo(); ?>">
		<input type="hidden" name="txtAcao" id="txtAcao" value="<?php echo $SeboController->getAcaoGET();?>">
		<label>Sebo</label>
		<input class="grande" type="text" name="txtNome" value="<?php echo $SeboController->getSeboDAO()->getNomeSebo(); ?>">
		<br>
	...
	<br>
	<br>
	<a href="http://localhost/Sebook_projeto/php/Sebook_dao/index.php?area=adm&folder=cadastro&page=cadSebo">Voltar</a>
</section>