...
<div class="container">
	<form action="" method="post" >
		...
		<div class="formItem">
			...
			<input type="text" name="nomeUsuario" id="nomeUsuario" required value="<?= $usuarioDAO->getNomeUsuario() ?>"
			onblur='valida_nome(this.value)'>
		</div>

		<div class="formItem">
			<label for="nomeUsuario">Sobrenome</label>
			<input type="text" name="sobrenomeUsuario" id="sobrenomeUsuario" required value="<?= $usuarioDAO->getSobrenomeUsuario()  ?>"
		...
		<div class="formItem">
			...
			?>
			<input type="text" name="nascCliente" id="nascCliente" required value="<?=trim($newDate) ?>"
			onblur='mascaraDataNasc(this)'>
		</div>
		...
		<div class="formItem">
			...
			<input type="text" name="cpfCliente" id="cpfCliente" required value="<?= $clienteDAO->getCpfCliente() ?>"
			onblur="valida(this.value)">
		</div>
		<div class="formItem">
			<label for="cepCliente">CEP</label>
			<input type="text" name="cepCliente" id="cepCliente" required value="<?= $clienteDAO->getCepCliente() ?>"
		...
		<div class="formItem">
			...
			<input type="text" name="numComplCliente" id="numComplCliente" required value="<?= $clienteDAO->getNumComplCliente() ?>"
			onblur="valida_numero(this.value);">
		</div>
		<div class="formItem">
