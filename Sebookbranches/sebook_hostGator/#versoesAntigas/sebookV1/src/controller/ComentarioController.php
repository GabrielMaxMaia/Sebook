        ...
        if ($result != null) {
            foreach ($result as $linha) {
                $tabela .= "<tr>
                        ...
                        <td>
                            <a href='http://Sebook/area/adm/cadastro/cadComentario/alter/" . $linha['idComentario'] . "'>
                                <img src='" . _URLBASE_ . "public/img/editar.jpg'>
                            </a>
                        </td>
                        <td>
                            <a href='http://Sebook/area/adm/cadastro/cadComentario/delete/" . $linha['idComentario'] . "'>
