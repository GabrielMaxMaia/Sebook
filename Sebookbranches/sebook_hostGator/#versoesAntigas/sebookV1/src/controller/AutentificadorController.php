...
class AutentificadorController
{
            ...
            if ($user !== null && $senha != null) {
                ...
                if ($resultado == false) {
                    ...
                    if (($_SESSION['userLogado']['acesso']) <= 3) {
                        echo "ADM";
                        header("Location: http://sebook/area/adm");
                    } else {
                        echo "Login usuário";
                        header("location: http://sebook/");
                    }
    ...
    public function toggleLogin()
    {
        ...
        if ($sessao == null) {
            ...
            if ($_SESSION['userLogado']['acesso'] <= 3) {
                $adm = "https://sebook.com.br/area/adm";
            }
            $perfil = "https://sebook.com.br/area/user/pages/perfilLeitor";
