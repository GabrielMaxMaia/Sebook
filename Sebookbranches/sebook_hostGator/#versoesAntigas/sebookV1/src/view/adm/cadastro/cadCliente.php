...
<section class="<?php echo $clienteController->getLista(); ?>">
	...
	<input class="button" type="button" onclick="window.location='http://sebook/area/adm/cadastro/cadCliente/add'" value="Novo">
</section>
...
<section class="<?php echo $clienteController->getFormulario(); ?>">
	...
	<div class="imgCadastro">
		<picture>
			<img id="imgAvatar" src="<?= "http://sebook/" . $clienteController->getClienteDAO()->getUrlFotoCliente()  ?>" alt="Avatar" class="avatar">
		</picture>
	</div>
	...
	<br>
	<br>
	<a href="http://Sebook/area/adm/cadastro/cadCliente">Voltar</a>
</section>