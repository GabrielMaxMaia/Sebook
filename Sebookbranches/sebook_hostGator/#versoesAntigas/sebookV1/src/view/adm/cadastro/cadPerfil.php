...
<section class="<?php echo $perfilCrontoller->getLista(); ?>">
	<table>
	 ...
	 <input class="button" type="button" onclick="window.location='http://sebook/area/adm/cadastro/cadPerfil/add'"
	 value="Novo">
</section>
...
<section class="<?php echo $perfilCrontoller->getFormulario(); ?>">
	...
	<br>
	<br>
	<a href="http://Sebook/area/adm/cadastro/cadPerfil">Voltar</a>
</section>