...
<section class="<?php echo $nacionalidadeController->getLista(); ?>">
	...
	<input class="button" type="button" onclick="window.location='http://Sebook/area/adm/cadastro/cadNacionalidade/add'" value="Novo">
</section>
...
<section class="<?php echo $nacionalidadeController->getFormulario(); ?>">
	...
	<br>
	<br>
	<a href="http://Sebook/area/adm/cadastro/cadNacionalidade">Voltar</a>
</section>