...
<section class="<?php echo $autorController->getLista(); ?>">
	...
	<input class="button" type="button" onclick="window.location='http://sebook/area/adm/cadastro/cadAutor/add'" value="Novo">
</section>
...
<section class="<?php echo $autorController->getFormulario(); ?>">
	...
	<br>
	<br>
	<a href="http://Sebook/area/adm/cadastro/cadAutor">Voltar</a>
</section>