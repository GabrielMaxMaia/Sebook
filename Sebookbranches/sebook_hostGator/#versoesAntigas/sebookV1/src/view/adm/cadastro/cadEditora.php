...
<section class="<?php echo $editoraController->getLista(); ?>">
	<table>
	 ...
	 <input class="button" type="button" onclick="window.location='http://Sebook/area/adm/cadastro/cadEditora/add'" value="Novo">
...
<section class="<?php echo $editoraController->getFormulario(); ?>">
	...
	<br>
	<br>
	<a href="http://Sebook/area/adm/cadastro/cadEditora">Voltar</a>
</section>