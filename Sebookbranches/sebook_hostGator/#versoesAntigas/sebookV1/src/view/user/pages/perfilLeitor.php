	...
	<div class="container">
		<form action="" method="post" >
			...
			<div class="formItem">
				...
				<input type="text" name="emailUsuario" id="emailUsuario" placeholder='aaaaaa@aaaa.aaa.aa' value="<?= $usuarioDAO->getEmailUsuario() ?>"
				onblur='alert(mascaraEmail(this))'>
			...
			<div class="formItem">
				...
				?>
				<input type="text" name="nascCliente" id="nascCliente" placeholder='00/00/0000' value="<?=trim($newDate) ?> ">
			</div>
			...
			<div class="formItem">
				...
				<input type="text" name="cpfCliente" id="cpfCliente" placeholder='000.000.000-00'value="<?= $clienteDAO->getCpfCliente() ?>">
			</div>
			<div class="formItem">
				<label for="cepCliente">CEP</label>
				<input type="text" name="cepCliente" placeholder='000.00.000' id="cepCliente" value="<?= $clienteDAO->getCepCliente() ?>">
			</div>
			<div class="formItem">
